...
import kotlinx.android.synthetic.main.rv_multiple_city_weather_row.view.iv_weather_condition
import kotlinx.android.synthetic.main.rv_multiple_city_weather_row.view.tv_temp_max
import kotlinx.android.synthetic.main.rv_multiple_city_weather_row.view.tv_temp_min
import kotlinx.android.synthetic.main.rv_multiple_city_weather_row.view.tv_weather_desc
import kotlinx.android.synthetic.main.rv_multiple_city_weather_row.view.tv_wind_speed
import kotlinx.android.synthetic.main.rv_my_city_weather_row.view.*

class MyCityWeatherAdapter(
    private val context: Context,
    private val weatherList: ArrayList<WeatherData>
) :
    RecyclerView.Adapter<MyCityViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyCityViewHolder {
        val layoutInflater = LayoutInflater.from(parent?.context)

        return MyCityViewHolder(
            layoutInflater.inflate(
                R.layout.rv_my_city_weather_row,
                parent,
                false
            )
        )
    ...
    override fun onBindViewHolder(holder: MyCityViewHolder, position: Int) {
        holder?.tv_date_and_time?.text = weatherList[position].dateTime
...
class MyCityViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    val tv_date_and_time = view.tv_date_and_time
